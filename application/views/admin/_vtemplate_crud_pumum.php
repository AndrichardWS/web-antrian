	...
	<ol class="breadcrumb bc-3" >
				...
				<a href="#"><i class="entypo-gauge"></i>Dashboard</a>
					...
					<li>
							...
							<a href="ui-panels.html">Data Poli Umum</a>
					</li>
				<!-- <li class="active">
...
<div class="row">
	<div class="col-md-12">
        ...
        $(document).ready(function(){
            $('.dataTables-example').DataTable({
                ...
                buttons: [
                    {extend: 'copy'},
                    {extend: 'csv'},
                    {extend: 'excel', title: 'Data Poli Umum'},
                    {extend: 'pdf', title: 'Data Poli Umum'},
		...
		<div class="pull">
            <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#ModalaAdd2"><i class="entypo-plus"></i>Tambah Data</a>

             <a href="C_crud_pumum/reset_data/" class="btn btn-sm btn-danger"><i class="entypo-cw"></i>Reset Data</a>
				...
				<tr class="odd gradeX">
					...
					<td class="center">
                        ...
                        <a 
                            ...
                            <a href="<?php echo base_url()?>admin/C_crud_pumum/hapus/<?php echo $u->no_antrian; ?>" class="btn btn-danger btn-sm" onClick="return confirm('Apakah anda yakin ingin menghapus data ini?')" ><i class="entypo-trash"></i></a> </td>
				</tr>
				 <?php } ?>
...
<!-- JS DETAIL -->
 <script>
    $(document).ready(function() {
        ...
        $("#IsiModal").html('<table width="520" align="center" cellpadding="1" cellspacing="1" style="font-size:15px;"><tr></tr><tr><td width="153"><b>No. Antrian</b></td><td width="23"><div align="center" >:</div></td><td width="326">'+"U"+ambildata[0]+'</td></tr><tr><td><b>Jalur</b></td><td><div align="center" >:</div></td><td>'+ambildata[1]+'</td></tr><tr><td><b>No. BPJS</b></td><td><div align="center" >:</div></td><td>'+ambildata[2]+'</td></tr><tr><td><b>NIK</b></td><td><div align="center" >:</div></td><td>'+ambildata[3]+'</td></tr><tr><td><b>Nama Lengkap</b></td><td><div align="center" >:</div></td><td>'+ambildata[4]+'</td></tr><tr><td><b>Jenis Kelamin</b></td><td><div align="center" >:</div></td><td>'+ambildata[5]+'</td></tr><tr><td><b>Tempat, Tanggal Lahir</b></td><td><div align="center" >:</div></td><td>'+ambildata[6]+'</td></tr></table>');
        });
    ...
    <!-- MODAL DETAIL -->
        <div class="modal fade" id="ModalDetail" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel"><i class="entypo-eye"></i> Detail Data Poli Umum</h3>
            </div>
...
<!-- MODAL ADD -->
        <div class="modal fade" id="ModalaAdd2" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="myModalLabel"><i class="fa fa-plus"></i> Tambah Data Poli Umum</h3>
            </div>
            <form class="form-horizontal" name="myform" action="<?php echo base_url()?>admin/C_crud_pumum/tambah" method="post">
        ...
        <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="edit-data" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h3 class="modal-title" id="myModalLabel"><i class="fa fa-pencil"></i> Edit Data Poli Umum</h3>
                    </div>

                    <form class="form-horizontal" name="myform2" action="<?php echo base_url()?>admin/C_crud_pumum/edit" method="post" enctype="multipart/form-data" role="form">
                        <div class="modal-body">
